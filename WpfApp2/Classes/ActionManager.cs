...
namespace WpfApp2.Classes
{
    ...
    {
        private static readonly string[] User_propertys =
            { "givenName", "sn", "userPrincipalName", "mail", "whenCreated", "lockoutTime" };
        public static string LDAP_connection = "test.local";
        public static string LDAP_path = "LDAP://OU=Users,OU=Pharma,OU=Moscow,OU=AdminUnits,DC=test,DC=local";
